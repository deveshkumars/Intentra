...
Example entries:
```
2026-03-13 | deveshkumars/myapp | fp | app/services/auth_service.rb | race-condition
2026-03-13 | deveshkumars/myapp | fix | app/models/user.rb | null-check
2026-03-13 | deveshkumars/myapp | already-fixed | lib/payments.rb | error-handling
```
