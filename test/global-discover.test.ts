...
describe("gstack-global-discover", () => {
  describe("normalizeRemoteUrl", () => {
    ...
    test("SSH and HTTPS for same repo normalize to same URL", () => {
      const ssh = normalizeRemoteUrl("git@github.com:deveshkumars/Intentra.git");
      const https = normalizeRemoteUrl("https://github.com/deveshkumars/Intentra.git");
      const httpsNoDotGit = normalizeRemoteUrl("https://github.com/deveshkumars/Intentra");
